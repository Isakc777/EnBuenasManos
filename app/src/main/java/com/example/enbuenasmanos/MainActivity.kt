        ...
        val stringRequest = StringRequest(Request.Method.GET, url, {response ->
            ...
            try {
                ...
                try {
                    ...
                    Log.d(TAG, "loandPost: NextPageToken: $nextToken")
                ...
                for(i in 0 until jsonArray.length()){
                    ...
                    try {
                        ...
                        val tittle = jsonObject01.getString("tittle");
                ...
                Log.d(TAG, "ladPost: 2 ${e.message} ")
                Toast.makeText(this, "${e.message}", Toast.LENGTH_SHORT).show()
            }


        }, { error ->
                Log.d(TAG, "loadPost: ${error.message}")
